...
ENSEMBLE_DIR = os.path.join(PROJECT_ROOT, "outputs", "models", "resnet_ensemble")

MODEL_PATHS = [
    os.path.join(ENSEMBLE_DIR, f"resnet{n}.pth") for n in (18, 34, 50, 101, 152)
]
...
def main():
    logger, RUN_DIR = setup_logger(
        model_name="ensemble_test", base_log_dir=config.LOG_DIR
    )
